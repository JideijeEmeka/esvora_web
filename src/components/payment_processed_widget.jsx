...
const PaymentProcessedWidget = ({ isOpen, onClose, onGoHome }) => {
		...
		>
			...
			>
				...
				<p className='text-[16px] text-gray-600 leading-relaxed mb-8'>
					Your payment request has been sent. You will get notified once approved.
				</p>
...
export default PaymentProcessedWidget
