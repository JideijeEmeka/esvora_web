...
export const FURNISHING_TYPES_SORTED = [...FURNISHING_TYPES].sort((a, b) => 
	a.label.localeCompare(b.label)
)

// Nigerian States Constants
// All 36 states plus Federal Capital Territory (FCT)
...
// States sorted alphabetically by label
export const NIGERIAN_STATES_SORTED = [...NIGERIAN_STATES].sort((a, b) => 
	a.label.localeCompare(b.label)
)
...
export const PROPERTY_TYPES = [
	...
	{ value: 'room-parlor', label: 'Room & Parlor' },
	{ value: 'single-room', label: 'Single Room' },
	{ value: 'shared-apartment', label: 'Shared Apartment' },
	{ value: 'event-hall', label: 'Event Hall' },
	{ value: 'shopping-hall', label: 'Shopping Hall' },
	{ value: 'selfcon', label: 'Selfcon' },
	{ value: 'store', label: 'Store' }
]

// Property types sorted alphabetically by label
export const PROPERTY_TYPES_SORTED = [...PROPERTY_TYPES].sort((a, b) => 
	a.label.localeCompare(b.label)
)

// Helper function to get property type label by value
export const getPropertyTypeLabel = (value) => {
	const type = PROPERTY_TYPES.find(t => t.value === value)
	return type ? type.label : ''
}

// Helper function to get state label by value
export const getStateLabel = (value) => {
	const state = NIGERIAN_STATES.find(s => s.value === value)
	return state ? state.label : ''
}

// Helper function to get furnishing label by value
export const getFurnishingLabel = (value) => {
	const furnishing = FURNISHING_TYPES.find(f => f.value === value)
	return furnishing ? furnishing.label : ''
}

// Nigerian Local Government Areas Constants
// Local government areas organized by state

export const NIGERIAN_LOCAL_GOVERNMENTS_BY_STATE = {
	abia: [
		...
		{ value: 'isukwuato', label: 'Isukwuato' },
	...
	imo: [
		...
		{ value: 'owerri-south', label: 'Owerri South' }
	],
	jigawa: [
	...
	lagos: [
		...
		{ value: 'amowo-odofin', label: 'Amuwo-Odofin' },
...
// Helper function to get local governments by state
export const getLocalGovernmentsByState = (stateValue) => {
	return NIGERIAN_LOCAL_GOVERNMENTS_BY_STATE[stateValue] || []
}
