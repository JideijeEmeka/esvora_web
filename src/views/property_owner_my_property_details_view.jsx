...
const PropertyOwnerMyPropertyDetailsView = () => {
  const onlyRateProperty = true
                    ...
                    return (
                      <div className='flex flex-col md:flex-row gap-3'>
                        <button
                          ...
                          onClick={() => {
                            window.scrollTo(0, 0)
                            navigate(`/property_owner/rate-property/${id}`)
                          }}
...
export default PropertyOwnerMyPropertyDetailsView
