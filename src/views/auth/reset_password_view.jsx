    ...
    <>
        ...
        <div className='w-full h-screen md:fixed max-md:items-center max-md:justify-start
          flex items-center justify-center px-6 lg:px-30 md:py-1 max-md:py-30 flex-col'>
            ...
            <h1 className='text-[24px] font-semibold max-md:px-10 w-[400px] py-6'>Create new password</h1>
            ...
            <ButtonWidget text="Reset password" onClick={() => navigate('/reset-password-success')} />
