...
const AddShortletHouseRegulationsView = () => {
	const navigate = useNavigate()
	const [regulations, setRegulations] = useState([
		{ id: 1, text: 'Check in at 10:00PM' },
		{ id: 2, text: 'Check out at 08:00AM' },
		{ id: 3, text: 'No fighting' },
		{ id: 4, text: 'No Smoking' }
	])
	...
	const handleSaveAndContinue = () => {
		saveAddListingDraft('shortlet', { regulations })
...
export default AddShortletHouseRegulationsView
